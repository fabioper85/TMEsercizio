...
@NamedQueries(
{
  ...
  , @NamedQuery(name = "MerceSpedizione.findByQuantit\u00e0", query = "SELECT m FROM MerceSpedizione m WHERE m.quantit\u00e0 = :quantit\u00e0")
})
public class MerceSpedizione implements Serializable, ChiavePrimaria
{
  ...
  public MerceSpedizione(Integer id, int quantità)
  {
    this.id = id;
